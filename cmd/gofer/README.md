...
command: `go get -u github.com/toknowwhy/theunit-oracle/cmd/gofer`.
...
like [oracle-v2](). For this reason, by default, a response is returned as
...
here: https://pkg.go.dev/github.com/toknowwhy/theunit-oracle/pkg/gofer
